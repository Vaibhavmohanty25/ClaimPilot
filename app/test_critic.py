...
adjudication = {
    ...
    "coverage_position": (
        "Partial coverage – supported items are likely payable "
        "under Own Damage Coverage, while unsupported items "
        "lack evidence and may be excluded."
    ),
    ...
    "reasoning": [
        "The core collision appears covered.",
        "Front bumper and left headlamp damage are supported.",
        "Bonnet and rear bumper damage are not sufficiently supported.",
        "The accident time remains contradictory.",
        "Missing information prevents a reliable payable amount calculation.",
    ],
    "human_review_required": True,
    "next_action": (
        "Request clarification regarding the accident time and obtain "
        "supporting evidence for bonnet and rear bumper damage."
    ),
}
